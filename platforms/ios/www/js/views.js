    ...
    notifyButtonFunction : function(ev) {
        ...
        document.addEventListener('deviceready',function(){
			...
			if(hoursToBegin > 168){
				...
				self.scheduleNotification(notiCounter,appointmentTitle,notificationMessage,_15_sec_after,0);
                ...
                Config.save();
				self.scheduleNotification(notiCounter,appointmentTitle,notificationMessage,_30_sec_after,1);
				self.displayAlert();
			}
