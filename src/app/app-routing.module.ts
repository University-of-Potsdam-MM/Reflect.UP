...
const routes: Routes = [
  ...
  { path: 'push-messages', loadChildren: () => import('./pages/push-messages/push-messages.module').then(m => m.PushMessagesPageModule) },
  { path: 'questions', loadChildren: () => import('./pages/questions/questions.module').then(m => m.QuestionsPageModule) },
  { path: 'select-module', loadChildren: () => import('./pages/select-module/select-module.module').then(m => m.SelectModulePageModule) },
  ...
  { path: 'terms-of-service', loadChildren: () => import('./pages/terms-of-service/terms-of-service.module').then(m => m.TermsOfServicePageModule) },
